            ...
            if (selectedOption) {
                ...
                if (selectedAnswer === correctAnswer) {
                    ...
                    wrongAnswers.push({
                        ...
                        userAnswer: `${selectedAnswer}. ${item.options[selectedAnswer.charCodeAt(0) - 97].split('. ')[1]}`,
                        correctAnswer: `${correctAnswer}. ${item.options[correctAnswer.charCodeAt(0) - 97].split('. ')[1]}`
                    });
                }
            } else {
                wrongAnswers.push({
